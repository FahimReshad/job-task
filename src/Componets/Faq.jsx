  ...
  return (
    <div className="mt-10 lg:mt-28">
      ...
      <div className="collapse collapse-arrow bg-[#FFFFF5] mb-4 px-6">
        ...
        <div className="collapse-content">
          <p>
            To schedule an appointment, determine the purpose and find a
            suitable date and time. Contact the relevant party via phone, email,
            or an online tool, providing necessary details. Confirm the
            appointment and set reminders.
          </p>
        </div>
      </div>
      <div className="collapse collapse-arrow bg-[#FFFFF5] mb-4 px-6">
        ...
        <div className="collapse-content">
          <p>
            Yes, we accept a variety of insurance plans. Please contact our
            office or check our website for a list of accepted providers and
            specific details about coverage.
          </p>
        </div>
      </div>
      <div className="collapse collapse-arrow bg-[#FFFFF5] mb-4 px-6">
        ...
        <div className="collapse-content">
          <p>
            For your appointment, please bring a valid photo ID, your insurance
            card, a list of current medications, and any relevant medical
            records. Additionally, bring a method of payment for any co-pays or
            fees.
          </p>
        </div>
      </div>
      <div className="collapse collapse-arrow bg-[#FFFFF5] mb-4 px-6">
        ...
        <div className="collapse-content">
          <p>
            ...
            consultations. Please contact our office or visit our website to
            check eligibility and schedule a virtual visit.
          </p>
        </div>
      </div>
    </div>
