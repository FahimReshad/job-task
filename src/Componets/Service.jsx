    ...
    <div className="mt-10 lg:mt-28 bg-[#FFFFF5] rounded-3xl p-10 grid md:grid-cols-2 gap-8">
      ...
      <div className=" relative">
        <div >
          <img
            ...
            src="../../public/Media/Rectangle 27-2.png"
            alt=""
          />
        </div>
        <div>
          <div className="shadow-xl bg-[#020043] opacity-85 text-white rounded-3xl p-5 lg:p-10 space-y-3 lg:space-y-6 lg:absolute left-6 bottom-6 w-fit mx-auto -mt-28 lg:-mt-0">
            <h2 className="text-xl md:text-4xl font-semibold">Advanced Technology</h2>
            <p className="md:text-xl font-medium">
            Our surgeons are trained in the <br /> latest robotic surgical <br /> techniques, which allow for <br /> greater precision
            </p>
          </div>
        </div>
      </div>
      ...
      <div className=" relative">
        <div >
          <img
            className="w-full h-full opacity-90 rounded-3xl"
            src="../../public/Media/Rectangle 27-1.png"
            alt=""
          />
        </div>
        <div>
          <div className="shadow-xl bg-[#020043] opacity-85 text-white rounded-3xl p-5 lg:p-10 space-y-3 lg:space-y-6 lg:absolute left-6 bottom-6 w-fit mx-auto -mt-28 lg:-mt-0">
            <h2 className="text-xl md:text-4xl font-semibold">Online Doctor Meet</h2>
      ...
      <div className=" relative">
        <div >
          <img
            className="w-full h-full opacity-90 rounded-3xl"
            src="../../public/Media/Rectangle 27.png"
            alt=""
          />
        </div>
        <div>
          <div className="shadow-xl bg-[#020043] opacity-85 text-white rounded-3xl p-5 lg:p-10 space-y-3 lg:space-y-6 lg:absolute left-6 bottom-6 w-fit mx-auto -mt-28 lg:-mt-0">
            <h2 className="text-xl md:text-4xl font-semibold">Consultancy your health</h2>
            <p className="lg:text-xl font-medium">
            Our surgeons are trained in the latest <br /> robotic surgical techniques, which <br /> allow for greater precision
            </p>
          </div>
