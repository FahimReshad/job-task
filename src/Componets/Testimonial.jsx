    ...
    <div className="mt-10 lg:mt-28">
      ...
      <div className="space-y-6">
       ...
       <div className="bg-[#FFFFF5] shadow-xl rounded-3xl border lg:row-start-6 lg:row-end-12 p-5 lg:col-start-7 lg:col-end-9 space-y-3">
        <h1 className="text-2xl lg:text-3xl font-bold text-[#020043]">Expertise and Compassion Combined</h1>
        ...
        <div className="flex gap-4">
            <div><img src="../../public/Media/Ellipse 10.png" alt="" /></div>
            <div>
                <h5 className="text-[#020043]"><span className="font-bold text-[#020043]">Sarah D, </span> IT Professional</h5>
       ...
       <div className="bg-[#FFFFF5] shadow-xl rounded-3xl border lg:row-start-6 lg:row-end-12 p-5 lg:col-start-7 lg:col-end-9 space-y-3">
        <h1 className="text-2xl lg:text-3xl font-bold text-[#020043]">Life-Saving Care, Life-Changing Experience</h1>
        <p className="text-[#020043] font-medium">
        ...
        <div className="flex gap-4">
            <div><img src="../../public/Media/Ellipse 10 (1).png" alt="" /></div>
            <div>
                <h5 className="text-[#020043]"><span className="font-bold text-[#020043]">Michael R, </span> Business Executive</h5>
                <div className="flex gap-1">
                <FaStar className="text-[#FFE03D]" />
                <FaStar className="text-[#FFE03D]" />
                <FaStar className="text-[#FFE03D]" />
       ...
       <div className="bg-[#FFFFF5] shadow-xl rounded-3xl border lg:row-start-6 lg:row-end-12 p-5 lg:col-start-7 lg:col-end-9 space-y-3">
        <h1 className="text-2xl lg:text-3xl font-bold text-[#020043]">A Partner in Health and <br />
        Wellness</h1>
        <p className="text-[#020043] font-medium">
        ...
        <div className="flex gap-4">
            <div><img src="../../public/Media/Ellipse 10 (2).png" alt="" /></div>
            <div>
                <h5 className="text-[#020043]"><span className="font-bold text-[#020043]">David S, </span> Lawyer</h5>
                <div className="flex gap-1">
                <FaStar className="text-[#FFE03D]" />
                <FaStar className="text-[#FFE03D]" />
                <FaStar className="text-[#FFE03D]" />
